    ...
    return (
        <div className='max-w-[80%] mx-auto mt-10'>
            ...
            <div className="tabs tabs-box justify-center bg-white">
                ...
                <div className="tab-content bg-base-100 mt-8 p-6"><ProductItems collectData = {collectData}/></div>

                <input onChange={()=>setClickProduct(false)} type="radio" name="my_tabs_6" className={`tab text-purple-800 ${clickProduct?"":"rounded-3xl bg-linear-to-r from-[#4F39F6] to-[#9514FA] text-white"}`} aria-label={`Chart(0)`} />
                <div className="tab-content bg-base-100 mt-8 p-6"><Charts/></div>
            </div>
        </div>
    );
};
